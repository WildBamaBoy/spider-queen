...
import spiderqueen.old.client.model.ModelCocoonZombie;
...
public class RenderCocoonZombie extends Render
{

    public RenderCocoonZombie()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonZombie();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/CzombieD.png");
		}
		else
		{
			loadTexture("/imgz/czombie.png");
		}
