...
//			SQR.likeChange("zombie",2);

			if(SQR.ZombieLike > 9)
			{
				SQR.ZombieLike = 0;
				SQR.outputTxt = "The zombies have given you one of their own.";

//				final EntityFZombie entCocoon = new EntityFZombie(world);//, entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.rotationYaw - 90F);//,itemstack.getItemDamage());
