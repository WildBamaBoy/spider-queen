...
public class RenderSpiderQueen extends RenderPlayer
{
	...
	public RenderSpiderQueen()
	{
		...
		spiderQueenTextures[0] = new ResourceLocation("sqr:textures/entities/spider-queen-1.png");
		armTextures[0] = new ResourceLocation("sqr:textures/entities/spider-queen-arms-1.png");
	}
