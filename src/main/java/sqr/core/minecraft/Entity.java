...
//            int j1 = worldObj.getBlock(x, y, z);
//
//            if (j1 > 0)
//            {
...
//            int j3 = worldObj.getBlock(l, j1, l1);
//
//            if (j3 == 0 && worldObj.getBlock(l, j1 - 1, l1) == Blocks.fence)
//            {
//                j3 = worldObj.getBlock(l, j1 - 1, l1);
//            }
//
...
//                Blocks.blocksList[j3].onEntityWalking(worldObj, l, j1, l1, this);
//            }
//        }
//
...
//                        if (i5 > 0)
//                        {
//                            Blocks.blocksList[i5].onEntityCollidedWithBlock(worldObj, j4, k4, l4, this);
//                        }
//                    }
//                }
//            }
...
//    {
//        StepSound stepsound = Blocks.blocksList[par4].stepSound;
//
//        if (worldObj.getBlock(par1, par2 + 1, par3) == Blocks.snow)
//        {
...
//        }
//        else if (!Blocks.blocksList[par4].blockMaterial.isLiquid())
//        {
//            worldObj.playSoundAtEntity(this, stepsound.getStepSound(), stepsound.getVolume() * 0.15F, stepsound.getPitch());
//        }
//    }
...
//
//                    if (l == 0 && worldObj.getBlock(x, y - 1, z) == Blocks.fence)
//                    {
//                        l = worldObj.getBlock(x, y - 1, z);
//                    }
//
//                    if (l > 0)
//                    {
//                        Blocks.blocksList[l].onFallenUpon(worldObj, x, y, z, this, fallDistance);
//                    }
//                }
//
//                fall(fallDistance);
...
//        int l = worldObj.getBlock(x, y, z);
//
//        if (l != 0 && Blocks.blocksList[l].blockMaterial == par1Material)
//        {
//            float f = BlockFluid.getFluidHeightPercent(worldObj.getBlockMetadata(x, y, z)) - 0.1111111F;
...
//		// SNIP
//		boolean doyaw = true;
//		if(ridingEntity instanceof EntityPoisonSpider)
//		{
//			EntityPoisonSpider ep = (EntityPoisonSpider) ridingEntity;
//			if(ep.getControlled()) { doyaw = false; }
//		}
//		if(ridingEntity instanceof EntityMinighast)
//		{
//			EntityMinighast ep = (EntityMinighast) ridingEntity;
//			if(ep.getControlled()) { doyaw = false; }
//		}
//
//		if(doyaw)
...
//
//
//    public void outfitWithItem(int x, int y, int z)
//    {
//    }
//
//
...
//
//        if (worldObj.isBlockNormalCube(x, y, z))
//        {
//            boolean flag = !worldObj.isBlockNormalCube(i - 1, j, k);
//            boolean flag1 = !worldObj.isBlockNormalCube(x +1, j, k);
//            boolean flag2 = !worldObj.isBlockNormalCube(x, y - 1, z);
//            boolean flag3 = !worldObj.isBlockNormalCube(i, y + 1, k);
//            boolean flag4 = !worldObj.isBlockNormalCube(x, y, z - 1);
//            boolean flag5 = !worldObj.isBlockNormalCube(i, j, z + 1);
//            byte byte0 = -1;
//            double d3 = 9999D;
//
//            if (flag && d < d3)
