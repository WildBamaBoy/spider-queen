...
import spiderqueen.old.client.model.ModelCocoonSheep;
...
public class RenderCocoonSheep extends Render
{

    public RenderCocoonSheep()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonSheep();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/CsheepD.png");
		}
		else
		{
			loadTexture("/imgz/Csheep.png");
		}
