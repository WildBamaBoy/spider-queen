...
import spiderqueen.old.client.model.ModelCocoonChicken;
...
public class RenderCocoonChicken extends Render
{

    public RenderCocoonChicken()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonChicken();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/cchickend.png");
		}
		else
		{
			loadTexture("/imgz/cchicken.png");
		}
