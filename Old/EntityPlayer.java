...
public abstract class EntityPlayer extends EntityLiving
{
	...
	// SNIP
    public EnumStatus sleepInWebBedAt(int i, int j, int k)
    {
        ...
        if(worldObj.blockExists(i, j, k))
        {
            ...
            int i1 = 1;
            func_22052_e(i1);
            setPosition((float)i + 0f, (float)j + 1.9375F, (float)k + 0f);
        } else
        {
            setPosition((float)i + 0.5F, (float)j + 1.9375F, (float)k + 0.5F);
        }
    ...
    {
		// SNIP
        return (worldObj.getBlockId(playerLocation.posX, playerLocation.posY, playerLocation.posZ) == Block.bed.blockID || worldObj.getBlockId(playerLocation.posX, playerLocation.posY, playerLocation.posZ) == mod_SpiderQueen.webBed.blockID);
    }
