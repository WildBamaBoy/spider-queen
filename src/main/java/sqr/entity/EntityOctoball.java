...
public class EntityOctoball extends Entity
{
	...
	public void setOctoballHeading(double d, double d1, double d2, float f, float f1)
	{
	...
	public void onUpdate()
	{
		...
		// else
		// {
		// this.worldObj.spawnParticle("bubble", this.posX, this.posY,
		...
		// if(!entity1.canBeCollidedWith() || entity1 == this.thrower &&
		// this.ticksInAirSnowball < 5)
		// {
		// continue;
		// }
		// final float f4 = 0.3F;
		...
		//
		// if(!movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeMobDamage(this.thrower),
		// 3));
		// }
		// for(int j = 0; j < 8; j++)
		// {
		...
		// for(this.rotationPitch = (float)(Math.atan2(this.motionY, f) * 180D /
		...
		// this.posY - this.motionY * f3, this.posZ - this.motionZ * f3,
