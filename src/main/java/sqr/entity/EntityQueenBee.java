...
//		if(entTrack != null)
//		{
//			final double dd = Math.sqrt(Math.pow(entTrack.posX-this.posX,2) + Math.pow(entTrack.posZ-this.posZ,2));
//			float amt = 0F;
...
//		if(entity != null) { SQR.pissOffBees(this.worldObj, entity, this.posX, this.posY, this.posZ, 64F); }
