...
public class ModelBoomSpider extends ModelBase
{

    public ModelBoomSpider()
    {
        float scale = 0F;
		...
		RearEnd.addBox(-5F, -4F, -6F, 10, 8, 12, scale);
		RearEnd.setRotationPoint(0F, 11F, 7F);
		RearEnd.rotateAngleX = 0.63284F;
