	...
	public void hurtArea(float explosionSize)
	{
		...
		for(int k2 = 0; k2 < list.size(); k2++)
		{
			...
			if(d4 <= 1.0D)
			{
				...
				if(entity instanceof EntitySpiderEx) { don = true; }
				if(entity instanceof EntityESpiderQueen) { final EntityESpiderQueen ee = (EntityESpiderQueen) entity; if(ee.getFriendly()) { don = true; } }
...
//			}
		...
		if(movingobjectposition != null)
		{
			if(movingobjectposition.entityHit != null)
			{
				...
				if(movingobjectposition.entityHit instanceof EntitySpiderEx) { don = true; }
				if(movingobjectposition.entityHit instanceof EntityESpiderQueen) { final EntityESpiderQueen ee = (EntityESpiderQueen) movingobjectposition.entityHit; if(ee.getFriendly()) { don = true; } }
