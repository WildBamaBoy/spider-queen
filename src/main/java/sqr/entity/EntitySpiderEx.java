...
//				this.worldObj.spawnParticle("largesmoke", entity.posX - this.motionX * 2, entity.posY - this.motionY * 2, entity.posZ - this.motionZ * 2, this.motionX, this.motionY, this.motionZ);
//				this.worldObj.spawnParticle("largesmoke", entity.posX - this.motionX * 2, entity.posY - this.motionY * 2, entity.posZ - this.motionZ * 2, this.motionX, this.motionY, this.motionZ);
//				entity.setDead();
//			}
//
//			this.attackTime = 20;
//			entity.attackEntityFrom(DamageSource.causeMobDamage(this), this.getAttackStrength());
//			this.xp = this.xp + 1;
//		}
//	}
...
//			health = this.maxhealth;
	...
	public void setXP(int xx) { this.xp = xx; }
//	public void addHP(int xx) { health = health + xx; if(health > this.maxhealth) { health = this.maxhealth; } }
