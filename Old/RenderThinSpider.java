...
import spiderqueen.old.client.model.ModelThinSpider;
import spiderqueen.old.entity.EntityFriendlySpider;

public class RenderThinSpider extends RenderLiving
{

    public RenderThinSpider()
    {
        super(new ModelThinSpider(), 1.0F);
        setRenderPassModel(new ModelThinSpider());
    }
