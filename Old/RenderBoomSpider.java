...
import spiderqueen.old.client.model.ModelBoomSpider;
import spiderqueen.old.entity.EntityFriendlySpider;

public class RenderBoomSpider extends RenderLiving
{

    public RenderBoomSpider()
    {
        super(new ModelBoomSpider(), 1.0F);
        setRenderPassModel(new ModelBoomSpider());
    }
