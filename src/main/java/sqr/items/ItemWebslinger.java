...
public class ItemWebslinger extends Item
{
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityPlayer)
	{
		...
		if (playerExtension.webEntity != null)
		{
			if (world.isRemote)
			{
				SpiderQueen.packetHandler.sendPacketToServer(new PacketDestroySlinger(playerExtension.webEntity.getEntityId(), entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ));
