...
//		}
//
//		return SQR.getClosestEntityToEntity(this.worldObj, this, 16D, 4); //worldObj.getClosestPlayerToEntity(this, 16D);
//	}
...
//			if(RadixMath.getDistanceToXYZ(this.posX,this.posY,this.posZ,this.entityToAttack.posX,this.entityToAttack.posY,this.entityToAttack.posZ) > 14D) { this.moveForward = moveSpeed; } else { this.moveForward = 0; }
//		}
//		if(this.tracking != null)
//		{
//			this.faceEntity(this.tracking, 30F, 30F);
//			if(SQR.getDistance3d(this.posX,this.posY,this.posZ,this.tracking.posX,this.tracking.posY,this.tracking.posZ) > 14D) { this.moveForward = moveSpeed; } else { this.moveForward = 0; }
//		}
...
//		if(this.tracking != null) { final EntityAnt nne = (EntityAnt)this.tracking; if(nne.getTracking() == this) { this.tracking = null; } }
//
...
//					if(rm2.nextInt(5) == 2)
//					{
//						this.tracking = SQR.getClosestEntityToEntity(this.worldObj, this, 32D, 6);
