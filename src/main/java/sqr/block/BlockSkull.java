...
//				final EntityFSkeleton entCocoon = new EntityFSkeleton(world);//, entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.rotationYaw - 90F);//,itemstack.getItemDamage());
...
//				world.spawnEntityInWorld(entCocoon);
	...
	{
		if(side == 1) { return SQR.texx[9]; }
		if(side == 0) { return SQR.texx[7]; }
		if(side == 2) { return SQR.texx[6]; }
		return SQR.texx[8];
	}
