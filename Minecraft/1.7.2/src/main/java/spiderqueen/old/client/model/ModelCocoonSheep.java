...
public class ModelCocoonSheep extends ModelBase
{

    public ModelCocoonSheep()
    {
		float scale = 0F;
		float y = -7F;
		Cocoon1 = new ModelRenderer(this,16, 8);
		Cocoon1.addBox(0F, 0F, 0F, 12, 12, 12, scale);
		Cocoon1.setRotationPoint(-6F, 9F+y, -6F);

		Cocoon2 = new ModelRenderer(this,20, 13);
		Cocoon2.addBox(0F, 0F, 0F, 10, 9, 10, scale);
		Cocoon2.setRotationPoint(-5F, 0F+y, -5F);

		Head = new ModelRenderer(this,0, 0);
		Head.addBox(-3F, -4F, -5F, 6, 6, 8, scale);
		Head.setRotationPoint(0F, 5F+y, -4F);
    }
