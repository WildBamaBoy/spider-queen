...
import spiderqueen.old.client.model.ModelCocoonSkeleton;
...
public class RenderCocoonSkeleton extends Render
{

    public RenderCocoonSkeleton()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonSkeleton();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/CskeletonD.png");
		}
		else
		{
			loadTexture("/imgz/Cskeleton.png");
		}
