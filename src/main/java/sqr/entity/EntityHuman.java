...
public class EntityHuman extends EntityCreature implements INewMob
{
	public EntityHuman(World world)
	{
		...
		// TODO
		// if(tt > 25) { this.myType = 2; this.myItem = defaultHeldItem2;
		// this.attackStrength = 5; }
		// if(tt > 50) { this.myType = 3; this.myItem = defaultHeldItem3;
		// this.attackStrength = 5; //TODO Attribute moveSpeed = 0.85F; }
		// if(tt > 70) { this.myType = 4; this.myItem = defaultHeldItem4;
		// this.attackStrength = 6; //TODO Attribute moveSpeed = 0.95F; }
		// if(tt > 80) { this.myType = 5; this.myItem = defaultHeldItem5;
		// this.attackStrength = 8; //TODO Attribute moveSpeed = 1F; }
		// if(tt > 90) { this.myType = 6; this.myItem = defaultHeldItem6;
		// this.attackStrength = 1; }
		// if(tt > 95) { this.myType = 7; this.myItem = defaultHeldItem7;
		// this.attackStrength = 1; }
	}
	...
	protected Entity findPlayerToAttack()
	{
		...
		if (entityplayer != null && this.canEntityBeSeen(entityplayer))
		{
			...
			{
				return null; // mod_SpiderQueen.getClosestEntityToEntity(worldObj,
								// this, 32D, 10);//entityplayer;
			}
		}
	...
	public boolean attackEntityFrom(DamageSource damagesource, float i)
	{
		...
		{
			// TODO
			// SQR.pissOffHumans(this.worldObj, entity, this.posX, this.posY,
			// this.posZ, 64F);
		}
	...
	public void onLivingUpdate()
	{
		...
		// if(spiderfriend)
		// {
		// if(this.entityToAttack instanceof EntityPlayer) { this.entityToAttack
		// = null; }
	...
	// this.myItem = defaultHeldItem1;
	// this.attackStrength = 3;
	// if(this.myType == 2) { this.myItem = defaultHeldItem2;
	// this.attackStrength = 5; }
	// if(this.myType == 3) { this.myItem = defaultHeldItem3;
	// this.attackStrength = 5; //TODO Attribute moveSpeed = 0.85F; }
	// if(this.myType == 4) { this.myItem = defaultHeldItem4;
	// this.attackStrength = 6; //TODO Attribute moveSpeed = 0.95F; }
	// if(this.myType == 5) { this.myItem = defaultHeldItem5;
	// this.attackStrength = 2; //TODO Attribute moveSpeed = 1F; }
	// if(this.myType == 6) { this.myItem = defaultHeldItem6;
	// this.attackStrength = 1; }
	// if(this.myType == 7) { this.myItem = defaultHeldItem7;
	// this.attackStrength = 1; }
	//
	// }
	//
