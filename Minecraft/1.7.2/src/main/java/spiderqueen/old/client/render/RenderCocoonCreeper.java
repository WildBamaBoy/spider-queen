...
import spiderqueen.old.client.model.ModelCocoonCreeper;
...
public class RenderCocoonCreeper extends Render
{

    public RenderCocoonCreeper()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonCreeper();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/ccreeperd.png");
		}
		else
		{
			loadTexture("/imgz/ccreeper.png");
		}
