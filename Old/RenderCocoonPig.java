...
import spiderqueen.old.client.model.ModelCocoonPig;
...
public class RenderCocoonPig extends Render
{

    public RenderCocoonPig()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonPig();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/cpigd.png");
		}
		else
		{
			loadTexture("/imgz/cpig.png");
		}
