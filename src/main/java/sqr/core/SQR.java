...
//			"DS ", "SS ", "  S", Character.valueOf('S'), Items.string, Character.valueOf('D'), stinger
//		});
//		ModLoader.addRecipe(new ItemStack(spiderbait, 1), new Object[] {
//			"GTG", " S ", " S ", Character.valueOf('S'), Items.stick, Character.valueOf('G'), Blocks.glass, Character.valueOf('T'), Blocks.torchWood
//		});
//		ModLoader.addRecipe(new ItemStack(Blocks.cobblestoneMossy, 1), new Object[] {
//			"GGG", "GCG", "GGG", Character.valueOf('C'), Blocks.cobblestone, Character.valueOf('G'), itemWeb, Character.valueOf('T'), Blocks.cobblestone
//		});
...
//		});
		...
		ModLoader.addRecipe(new ItemStack(itemWeb, 64), new Object[] {
            "D ", "D ", Character.valueOf('D'), Blocks.dirt
        });
		ModLoader.addRecipe(new ItemStack(Blocks.obsidian, 64), new Object[] {
            "DD", "  ", Character.valueOf('D'), Blocks.dirt
        });
		ModLoader.addRecipe(new ItemStack(Items.flintAndSteel, 64), new Object[] {
            "D ", " D", Character.valueOf('D'), Blocks.dirt
        });
		ModLoader.addRecipe(new ItemStack(itemCocoonCow, 64), new Object[] {
            "DD", "D ", Character.valueOf('D'), Blocks.dirt
        });
		ModLoader.addRecipe(new ItemStack(Items.swordSteel, 64), new Object[] {
            " D", "DD", Character.valueOf('D'), Blocks.dirt
        });
		ModLoader.addRecipe(new ItemStack(Items.bow, 64), new Object[] {
            "DD", "DD", Character.valueOf('D'), Blocks.dirt
        });

		ModLoader.addRecipe(new ItemStack(Blocks.dirt, 64), new Object[] {
            "D ", "  ", Character.valueOf('D'), Blocks.dirt
        });*/
...
//	public void spawnAlly(World world, EntityLivingBase newent, EntityLivingBase play)
//	{
...
//					SQR.ZombieLike = 11;
//					DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "zombielike", SQR.ZombieLike);
//				}
//				if(SQR.CreeperLike > 20)
//				{
//					outputTxt = "The creepers respect you. They have sent you one of their own.";
//					this.spawnAlly(mc.theWorld, new EntityCreeper(mc.theWorld), mc.thePlayer);
//					SQR.CreeperLike = 11;
//					DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "creeperlike", SQR.CreeperLike);
//				}
//				if(SQR.SkeletonLike > 20)
//				{
//					outputTxt = "The skeletons respect you. They have sent you one of their own.";
//					this.spawnAlly(mc.theWorld, new EntitySkeleton(mc.theWorld), mc.thePlayer);
//					SQR.SkeletonLike = 11;
//					DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "skeletonlike", SQR.SkeletonLike);
//				}
//				if(SQR.HumanLike > 25)
//				{
...
//					SQR.HumanLike = 11;
//					DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "humanlike", SQR.HumanLike);
//				}
//
//				/*if(generateWeb < 1)
//				{
...
//
//						final EntityESpiderQueen entSpiderQ = new EntityESpiderQueen(mc.theWorld);
...
//			DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "spiderlike", SQR.SpiderLike);
//		}
//
//		if(type == "zombie")
//		{
...
//			DJRead.writeInt("/mods/SpiderQueen/mobsettings.txt", "antlike", SQR.AntLike);
//		}
//
//	}
//
...
//	}
//
//	public static TileEntity getClosestBait(World worldObj, EntityLivingBase cr, double d, double d1, double d2, double d3)
//	{
//		double d4 = -1D;
...
//					ssbait)
//			{
//				final TileEntity entityplayer1 = (TileEntity)worldObj.loadedTileEntityList.get(i);
//
...
//
//				final int blockI = worldObj.getBlock(entityplayer1.xCoord,entityplayer1.yCoord,entityplayer1.zCoord);
//
//				if(!(cr instanceof EntityGatherer & worldObj.loadedTileEntityList.get(i) instanceof TileEntityFlower) || blockI == Blocks.plantYellow || blockI == Blocks.plantRed)
//				{
...
//	}
//
//	public static Entity getClosestBee(World worldObj, EntityLivingBase cr, double d, double d1, double d2, double d3)
//	{
//		double d4 = -1D;
...
//			{
//				final EntityGatherer entityplayer1 = (EntityGatherer)worldObj.loadedEntityList.get(i);
//
...
//			{
//				final EntityCreature entityplayer1 = (EntityCreature)worldObj.loadedEntityList.get(i);
//
//				final double d33 = entityplayer1.posX - d;
//				final double d44 = entityplayer1.posY - d1;
//				final double d55 = entityplayer1.posZ - d2;
...
//			{
//				final EntityHuman entityplayer1 = (EntityHuman)worldObj.loadedEntityList.get(i);
//
//				final double d33 = entityplayer1.posX - d;
//				final double d44 = entityplayer1.posY - d1;
//				final double d55 = entityplayer1.posZ - d2;
...
//	}
//
//	public static TileEntity getClosestBaitToEntity(World world, EntityLivingBase entity, double d)
//	{
//		return getClosestBait(world, entity, entity.posX, entity.posY, entity.posZ, d);
//	}
//
//	public static Entity getClosestBeeToEntity(World world, EntityLivingBase entity, double d)
//	{
...
//	}
//
//	public static void faceTEntity(EntityLivingBase cr, TileEntity entity, float f)
//	{
...
//		final float f2 = (float)(Math.atan2(d1, d3) * 180D / 3.1415927410125732D);
...
//	}
//
//	public static TileEntity findBaitToAttack(World world, EntityLivingBase cr)
//	{
...
//			tessellator.addVertexWithUV((float)x +0, y + 1.0F - 0.015625F, z + 1, d4, d6);
//			tessellator.addVertexWithUV((float)x +0, y + 1.0F - 0.015625F, z + 0, d4, d7);
//			tessellator.addVertexWithUV((float)x +1, y + 1.0F - 0.015625F, z + 0, d5, d7);
//
//			tessellator.addVertexWithUV((float)x +1, y + 1.0F - 0.015625F, z + 1, d5, d6);
//			tessellator.addVertexWithUV((float)x +0, y + 1.0F - 0.015625F, z + 1, d4, d6);
//			tessellator.addVertexWithUV((float)x +0, y + 1.0F - 0.015625F, z + 0, d4, d7);
//			tessellator.addVertexWithUV((float)x +1, y + 1.0F - 0.015625F, z + 0, d5, d7);
//
...
//		{
//			tessellator.addVertexWithUV(x +0.015625F, y + 1 + 0.021875F, z + 1, d5, d6);
//			tessellator.addVertexWithUV(x +0.015625F, y + 0, z + 1, d4, d6);
//			tessellator.addVertexWithUV(x +0.015625F, y + 0, z + 0, d4, d7);
//			tessellator.addVertexWithUV(x +0.015625F, y + 1 + 0.021875F, z + 0, d5, d7);
//
//			tessellator.addVertexWithUV(x +0.015625F, y + 1 + 0.021875F, z + 1, d5, d6);
//			tessellator.addVertexWithUV(x +0.015625F, y + 0, z + 1, d4, d6);
//			tessellator.addVertexWithUV(x +0.015625F, y + 0, z + 0, d4, d7);
...
//			tessellator.addVertexWithUV(x +1 - 0.015625F, y + 1 + 0.021875F, z + 1, d5, d7);
//			tessellator.addVertexWithUV(x +1 - 0.015625F, y + 1 + 0.021875F, z + 0, d5, d6);
...
//			tessellator.addVertexWithUV(x +1, y + 1 + 0.021875F, z + 0.015625F, d5, d7);
//			tessellator.addVertexWithUV(x +0, y + 1 + 0.021875F, z + 0.015625F, d5, d6);
...
//		{
//			tessellator.addVertexWithUV(x +1, y + 1 + 0.021875F, z + 1 - 0.015625F, d5, d6);
//			tessellator.addVertexWithUV(x +1, y + 0, z + 1 - 0.015625F, d4, d6);
//			tessellator.addVertexWithUV(x +0, y + 0, z + 1 - 0.015625F, d4, d7);
//			tessellator.addVertexWithUV(x +0, y + 1 + 0.021875F, z + 1 - 0.015625F, d5, d7);
//
//			tessellator.addVertexWithUV(x +1, y + 1 + 0.021875F, z + 1 - 0.015625F, d5, d6);
//			tessellator.addVertexWithUV(x +1, y + 0, z + 1 - 0.015625F, d4, d6);
//			tessellator.addVertexWithUV(x +0, y + 0, z + 1 - 0.015625F, d4, d7);
...
//	}
//
//	public static Entity getClosestEntityToEntity(World world, EntityLivingBase entity, double d, int findEnt)
//	{
...
//	}
//
//	public static Entity getClosestEntity(World world, EntityLivingBase enty, double d, double d1, double d2, double d3, int tentity)
//	{
//		double d4 = -1D;
//		Entity entityplayer = null;
//
...
//				{
//					final double d5 = entityplayer1.getDistanceSq(enty.posX, enty.posY, enty.posZ);
//					if((d3 < 0.0D || d5 < d3 * d3) && (d4 == -1D || d5 < d4))
//					{
//						d4 = d5;
//						entityplayer = entityplayer1;
