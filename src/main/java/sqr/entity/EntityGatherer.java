...
//			if(rm.nextInt() == 150)
//			{
//				if(this.fPlay == null) { this.fPlay = SQR.findBaitToAttack(this.worldObj,this); }
//			}
//			if(this.fPlay != null)
//			{
//				final int bbid = this.worldObj.getBlock(this.fPlay.xCoord, this.fPlay.yCoord, this.fPlay.zCoord);
...
//				else
//				{
//					if(SQR.getDistance3d(this.posX, this.posY, this.posZ, this.fPlay.xCoord, this.fPlay.yCoord, this.fPlay.zCoord) > 6F)
//					{
...
//	}
	...
	public boolean attackEntityFrom(DamageSource damageSource, float f)
	{
		if (damageSource != null)
		{
			...
			{ 
				//TODO
				//SQR.pissOffBees(this.worldObj, entity, this.posX, this.posY, this.posZ, 64F); 
			}
		}
