...
import spiderqueen.old.client.model.ModelCocoonBee;
...
public class RenderCocoonQueenBee extends Render
{

    public RenderCocoonQueenBee()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonBee();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/cqbeed.png");
		}
		else
		{
			loadTexture("/imgz/cqbee.png");
		}
