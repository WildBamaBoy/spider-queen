...
public class EntityYuki extends EntityCreature implements INewMob
{
	...
	protected void attackEntity(Entity entity, float f)
	{
		if (f < 16F)
		{
			...
			if (this.attackTime == 0)
			{
				...
				// worldObj.playSoundAtEntity(this, "random.bow", 1.0F, 1.0F /
				// (rand.nextFloat() * 0.4F + 0.8F));
				this.worldObj.spawnEntityInWorld(entityarrow);
				// entityarrow.setArrowHeading(d, d2 + (double)f1, d1, 0.6F,
				// 12F);
				this.attackTime = 60;
			}
	...
	protected Entity findPlayerToAttack()
	{
		/*
		 * Entity nn = null; nn =
		 * mod_SpiderQueen.getClosestEntityToEntity(worldObj, this, 16D, 5);
