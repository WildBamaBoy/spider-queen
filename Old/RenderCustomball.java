...
public class RenderCustomball extends Render
{
            ...
            float f, float f1)
    {
        ...
        float f2 = (float)((mod_SpiderQueen.texx[ntex] % 16) * 16 + 0) / 256F;
        float f3 = (float)((mod_SpiderQueen.texx[ntex] % 16) * 16 + 16) / 256F;
        float f4 = (float)((mod_SpiderQueen.texx[ntex] / 16) * 16 + 0) / 256F;
        float f5 = (float)((mod_SpiderQueen.texx[ntex] / 16) * 16 + 16) / 256F;
        float f6 = 1.0F;
        float f7 = 0.5F;
        float f8 = 0.25F;
