...
public class EntityFriendlyZombie extends EntityZombie implements IFriendlyEntity
{
	...
	public EntityFriendlyZombie(World world, EntityPlayer friendPlayer)
	{
		...
		//this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntityFakePlayer.class, 1.0D, false)); //TODO
		...
		//this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, EntityFakePlayer.class, 16, false)); //TODO
	}
