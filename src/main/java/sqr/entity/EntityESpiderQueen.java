...
public class EntityESpiderQueen extends EntityCreature
{
	...
	public void setFriendly(boolean f)
	{
		...
		if (this.friendly)
		{
			...
			// if(this.texID == 1) { //TODO texture
			// ="/imgz/spiderqueenskin3.png"; }
			// if(this.texID == 2) { //TODO texture
			// ="/imgz/spiderqueenskin4.png"; }
		}
	...
	public void onLivingUpdate()
	{
		...
		if (rm.nextInt(150) == 0)
		{
			...
			if (rm.nextInt(25) == 0 & !this.nospecial & this.getHealth() < 40)
			{
				this.nospecial = true;
	...
	// else
	// {
	// if(fPlay == null) { fPlay = (TileEntity)
	// mod_SpiderQueen.getClosestBait(worldObj, this, posX, posY, posZ, 64D); }
	// if(fPlay != null)
	// {
	// if(mod_SpiderQueen.getDistance3d(posX,posY,posZ,fPlay.xCoord,fPlay.yCoord,fPlay.zCoord)
	// > 16D)
	...
	// {
	// if(mod_SpiderQueen.getDistance3d(posX, posY, posZ, epl.posX, epl.posY,
	// epl.posZ) > 16F)
	// {
	// setAte(10);
	// fPlay = null;
	...
	// motionX = (d / (double)f2) * 0.5D * 0.80000001192092896D + motionX *
	// 0.20000000298023224D;
	// motionZ = (d1 / (double)f2) * 0.5D * 0.80000001192092896D + motionZ *
	// 0.20000000298023224D;
	...
	public void setAttackMode(int i)
	{
		...
		if (i == 2)
		{
			this.myItem = defaultHeldItem2;
		}
		if (i == 3)
		{
			this.myItem = defaultHeldItem3;
		}
	}
