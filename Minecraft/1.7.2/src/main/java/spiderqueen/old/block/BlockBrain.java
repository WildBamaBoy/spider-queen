...
public class BlockBrain extends BlockContainer
{

    protected BlockBrain(int i, int j)
    {
    ...
    public void updateTick(World world, int i, int j, int k, Random random)
    {
        int meta = world.getBlockMetadata(i,j,k);
			...
			if(meta > 13)
			{
				...
				mod_SpiderQueen.likeChange("zombie",2);
				
				if(mod_SpiderQueen.ZombieLike > 9)
				{
					mod_SpiderQueen.ZombieLike = 0;
					mod_SpiderQueen.outputTxt = "The zombies have given you one of their own.";
					
					EntityFZombie entCocoon = new EntityFZombie(world);//, entityplayer.posX, entityplayer.posY, entityplayer.posZ, entityplayer.rotationYaw - 90F);//,itemstack.getItemDamage());
    ...
    {
		return mod_SpiderQueen.texx[12];
	}
