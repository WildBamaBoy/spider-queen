...
import spiderqueen.old.client.model.ModelCocoonWolf;
...
public class RenderCocoonWolf extends Render
{

    public RenderCocoonWolf()
    {
        shadowSize = 0.5F;
        modelCC = new ModelCocoonWolf();
    }
            ...
            float f, float f1)
    {
		...
		{
			loadTexture("/imgz/cwolfd.png");
		}
		else
		{
			loadTexture("/imgz/cwolf.png");
		}
