	...
	public void onUpdate()
	{
		...
		if(this.tTime < 1)
		{
			if(this.target != null)
			{
				...
				if(!this.target.isEntityAlive() || rm.nextInt(500) == 0) { this.target = null; }
			}
		}
		else
		{
...
//		{
//			final Block i = this.worldObj.getBlock(this.xTileSnowball, this.yTileSnowball, this.zTileSnowball);
