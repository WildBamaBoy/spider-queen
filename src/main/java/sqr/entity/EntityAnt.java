...
public class EntityAnt extends EntityCreature
{
	...
	{
		super(world);
		// //TODO texture ="/imgz/antskinb.png";
		// //TODO Attribute moveSpeed = 0.6F;
	...
	// }
	//
	// return SQR.getClosestEntityToEntity(this.worldObj, this, 16D, 4);
	// //worldObj.getClosestPlayerToEntity(this, 16D);
	// }
	...
	protected void updateEntityActionState()
	{
		...
		// if(RadixMath.getDistanceToXYZ(this.posX,this.posY,this.posZ,this.entityToAttack.posX,this.entityToAttack.posY,this.entityToAttack.posZ)
		// > 14D) { this.moveForward = moveSpeed; } else { this.moveForward = 0;
		// }
		// }
		// if(this.tracking != null)
		// {
		// this.faceEntity(this.tracking, 30F, 30F);
		// if(SQR.getDistance3d(this.posX,this.posY,this.posZ,this.tracking.posX,this.tracking.posY,this.tracking.posZ)
		// > 14D) { this.moveForward = moveSpeed; } else { this.moveForward = 0;
		// }
		// }
		...
		// if(this.entityToAttack == null)
		// {
		// if(rm.nextInt(3) == 1) { this.entityToAttack =
		...
		// this.rotationYaw = (float)(Math.atan2(d5, d4) * 180D /
		// 3.1415927410125732D) - 90F;
	...
	{
		// TODO Some AI and block replacing here.
		// if(this.isInWater()) { this.setDead(); return; }
		//
		// if(this.entityToAttack != null) { this.tracking = null; }
		// if(this.tracking != null) { final EntityAnt nne =
		// (EntityAnt)this.tracking; if(nne.getTracking() == this) {
		// this.tracking = null; } }
		//
		...
		// final Random rr = new Random();
		// for(int xx=-1; xx<=1; xx++){ for(int yy=-1; yy<=1; yy++){ for(int
		// zz=-1; zz<=1; zz++){
		// if(yy < 1 || rr.nextInt(5) == 0)
		// {
		// if(rr.nextInt(10) == 0 & (rr.nextInt(4) == 0 || xx != 0 || zz != 0 ||
		// yy < 1))
		// {
		// final int id = this.worldObj.getBlock(pX+xx,pY+yy,pZ+zz);
		// if(id == Blocks.dirt || id == Blocks.grass || id == Blocks.stone)
		// {
		// this.worldObj.setBlockWithNotify(pX+xx,pY+yy,pZ+zz,0);
		// }
		// }
		// }
		// }}}
		...
		// if(rr.nextInt(100) == 0)
		// {
		// this.antId = this.antId - 50 + rr.nextInt(50); this.leader = false;
		// this.tracking = null; this.updateEntityActionState();
		// }
		//
		// if(this.tracking == null)
		// {
		...
		// if(rm2.nextInt(5) == 2)
		// {
		// this.tracking = SQR.getClosestEntityToEntity(this.worldObj, this,
		// 32D, 6);
