...
public class ItemWebslinger extends Item
{
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
		...
		// {
		//
		// final Vec3 ww = Vec3.createVectorHelper(entityplayer.posX -
		// entityplayer.webEntity.posX, entityplayer.posY -
		// entityplayer.webEntity.posY, entityplayer.posZ -
		// entityplayer.webEntity.posZ).normalize();
		...
		// else
		// {
		// world.playSoundAtEntity(entityplayer, "random.bow", 0.5F, 0.4F /
