...
public class ModelBeetle extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.Horn3.rotateAngleY = this.Head.rotateAngleY;
		this.Horn3.rotateAngleX = this.Head.rotateAngleX;
		this.Horn3.rotateAngleZ = this.Head.rotateAngleZ;
		 ...
		 * head.rotateAngleX; antenna2.rotateAngleY = head.rotateAngleY;
