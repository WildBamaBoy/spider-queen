...
//		{
//			final TileEntity entityplayer1 = (TileEntity)world.loadedTileEntityList.get(ss);
//			if(entityplayer1 instanceof TileEntityHBait)
//			{
//				final double d5 = SQR.getDistance3d(entityplayer1.xCoord, entityplayer1.yCoord, entityplayer1.zCoord, x, y, z);
//				if(d5 < 16 * 16 && (d4 == -1D || d5 < d4))
//				{
//					final int bID = this.worldObj.getBlock(entityplayer1.xCoord, entityplayer1.yCoord, entityplayer1.zCoord);
//					if(what == bID)
//					{
...
//			final EntityCocoon coc = (EntityCocoon)entityplayer;
//			coc.setEaten(true);
//			final EntityPoisonSpider nent = new EntityPoisonSpider(this.worldObj);
//			nent.setPosition(this.posX,this.posY + 1,this.posZ);
//			this.worldObj.spawnEntityInWorld(nent);
//			return true;
//		}
...
//				final EntityESpiderQueen nent = new EntityESpiderQueen(this.worldObj);
//				nent.setPosition(this.posX,this.posY + 1,this.posZ);
...
//		}
	...
	public void onUpdate()
	{
		...
		if(this.eggHatch > 1000)
		{
			...
			{
				//TODO
//				final EntityTinySpider nent = new EntityTinySpider(this.worldObj);
