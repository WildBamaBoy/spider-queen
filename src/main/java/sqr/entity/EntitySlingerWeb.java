...
public class EntitySlingerWeb extends Entity
{
	...
	public void matchMotion(int typ, double amt)
	{
		...
		if (typ == 0)
		{
			...
			{
				this.field_4096_c.motionX = this.field_4096_c.motionX - amt2;
			}
		}
		if (typ == 1)
		{
			...
			if (this.field_4096_c != null)
			{
				this.field_4096_c.motionY = this.field_4096_c.motionY - amt2;
			}
		}
		if (typ == 2)
		{
			...
			if (this.field_4096_c != null)
			{
				this.field_4096_c.motionZ = this.field_4096_c.motionZ - amt2;
			}
		}
	}
	...
	public void onUpdate()
	{
		...
		if (this.holder != null & (this.field_4091_h || this.field_4096_c != null))
		{
			...
			if (this.ddist == 0)
			{
				this.ddist = ww.squareDistanceTo(aa);
			}
			if (ww.squareDistanceTo(aa) > this.ddist / 4 * 3)
			{
				...
				double dd2 = 0.3D;// + (ww.squareDistanceTo(aa) - ddist) /
									// (ddist);
				...
				if (this.holder.posX > this.posX)
				{
					if (tmotionX < this.holder.motionX)
					{
						this.matchMotion(0, tmotionX);
					}
				}
				else
				{
				...
				if (this.holder.posY > this.posY)
				{
					if (tmotionY < this.holder.motionY)
					{
						this.matchMotion(1, tmotionY);
					}
				}
				else
				{
				...
				if (this.holder.posZ > this.posZ)
				{
					if (tmotionZ < this.holder.motionZ)
					{
						this.matchMotion(2, tmotionZ);
					}
				}
				else
				{
			...
			else
			{
				...
				{
					// Replaces isJumping.
					if (this.angler.isAirBorne)
					{
						this.ddist = this.ddist - 6;
					}
				}
			}
		}
