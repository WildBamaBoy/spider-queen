...
Leg1.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg1.setRotationPoint(-2, 11, 2);
...
Leg2.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg2.setRotationPoint(3, 11, 2);

Leg2.rotateAngleX = 7.750819E-16F;
Leg2.rotateAngleY = 0F;
Leg2.rotateAngleZ = 0F;

Leg3 = new ModelRenderer(this,22, 13);
Leg3.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg3.setRotationPoint(-2, 11, 0);
...
Leg4.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg4.setRotationPoint(3, 11, 0);
...
Leg5.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg5.setRotationPoint(-2, 11, -2);
...
Leg6.addBox(-1, -1, 0, 1, 10, 1, 0F);
Leg6.setRotationPoint(3, 11, -2);
...
Antenna1.setRotationPoint(0, 9, -3);
...
Antenna2.setRotationPoint(0, 9, -3);
...
RearEnd3.addBox(-3, -5, 13, 6, 6, 2, 0F);
RearEnd3.setRotationPoint(0, 9, 6);

RearEnd3.rotateAngleX = -0.9662092F;
RearEnd3.rotateAngleY = 0F;
RearEnd3.rotateAngleZ = 0F;

Stinger = new ModelRenderer(this,39, -7);
Stinger.addBox(0, -9, -18, 0, 3, 7, 0F);
Stinger.setRotationPoint(0, 9, 6);

Stinger.rotateAngleX = 1.348549F;
Stinger.rotateAngleY = 3.141593F;
Stinger.rotateAngleZ = 0F;

RearEnd2 = new ModelRenderer(this,0, 12);
RearEnd2.addBox(-5, -4, 2, 10, 8, 12, 0F);
RearEnd2.setRotationPoint(0, 9, 6);

RearEnd2.rotateAngleX = -0.7853982F;
RearEnd2.rotateAngleY = 0F;
RearEnd2.rotateAngleZ = 0F;

RearEnd1 = new ModelRenderer(this,3, 24);
RearEnd1.addBox(-3, -3, 0, 6, 6, 2, 0F);
RearEnd1.setRotationPoint(0, 9, 6);

RearEnd1.rotateAngleX = -0.7853982F;
