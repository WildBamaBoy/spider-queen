...
public enum EnumCocoonType
{
	...
	HUMAN(EntityFakePlayer.class, 4, "null", EnumCocoonSize.NORMAL, EnumSpiderSize.NORMAL), 
	...
	GHAST(EntityGhast.class, 1, "mob.ghast.death", EnumCocoonSize.HUGE, EnumSpiderSize.GHAST),
