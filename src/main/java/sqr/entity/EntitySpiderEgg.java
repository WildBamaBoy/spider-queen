...
public class EntitySpiderEgg extends Entity
{
	...
	// TODO
	// public boolean getBait(World world, double i, double j, double k, int
	// what, boolean doMove)
	// {
	// double d4 = 16D;
	...
	// (TileEntity)world.loadedTileEntityList.get(ss);
	// if(entityplayer1 instanceof TileEntityHBait)
	// {
	// final double d5 = SQR.getDistance3d(entityplayer1.xCoord,
	// entityplayer1.yCoord, entityplayer1.zCoord, x, y, z);
	// if(d5 < 16 * 16 && (d4 == -1D || d5 < d4))
	// {
	// final int bID = this.worldObj.getBlock(entityplayer1.xCoord,
	// entityplayer1.yCoord, entityplayer1.zCoord);
	// if(what == bID)
	// {
	// pX = entityplayer1.xCoord;
	// pY = entityplayer1.yCoord;
	// pZ = entityplayer1.zCoord;
	//
	// d4 = d5;
	...
	// if(doMove)
	// {
	// this.worldObj.setBlockWithNotify(pX,pY,pZ,0);
	// }
	// return true;
	// }
	// return false;
	...
	public boolean getClosestCocoon(World world, double d, double d1, double d2, double d3)
	{
		...
		// {
		// final EntityCocoon coc = (EntityCocoon)entityplayer;
		// coc.setEaten(true);
		// final EntityThinSpider nent = new EntityThinSpider(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		...
		// final EntityCocoon coc = (EntityCocoon)entityplayer;
		// coc.setEaten(true);
		// final EntityFurrySpider nent = new EntityFurrySpider(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		// this.worldObj.spawnEntityInWorld(nent);
		// return true;
		// }
		...
		// final EntityCocoon coc = (EntityCocoon)entityplayer;
		// coc.setEaten(true);
		// final EntityPoisonSpider nent = new
		// EntityPoisonSpider(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		// this.worldObj.spawnEntityInWorld(nent);
		// return true;
		// }
		...
		// final EntityCocoon coc = (EntityCocoon)entityplayer;
		// coc.setEaten(true);
		// final EntityBoomSpider nent = new EntityBoomSpider(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		// this.worldObj.spawnEntityInWorld(nent);
		// return true;
		// }
		...
		// final EntityCocoon coc = (EntityCocoon)entityplayer;
		// coc.setEaten(true);
		// if(this.getBait(world,this.posX,this.posY,this.posZ,SQR.royalblood,false))
		// {
		// this.getBait(world,this.posX,this.posY,this.posZ,SQR.royalblood,true);
		// final EntityESpiderQueen nent = new
		// EntityESpiderQueen(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		...
		// else
		// {
		// final EntitySpiderEx nent = new EntitySpiderEx(this.worldObj);
		// nent.setPosition(this.posX,this.posY + 1,this.posZ);
		// this.worldObj.spawnEntityInWorld(nent);
		// }
		// return true;
	...
	public void onUpdate()
	{
		...
		if (this.eggHatch > 1000)
		{
			this.setDead();
			this.eggHatch = 0;
			if (!this.getClosestCocoon(this.worldObj, this.posX, this.posY, this.posZ, 8D))
			{
				// TODO
				// final EntityTinySpider nent = new
				// EntityTinySpider(this.worldObj);
