...
public class ModelGatherer extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.bucket2.rotateAngleX = this.rightarm.rotateAngleX;
		this.bucket2.rotateAngleY = this.rightarm.rotateAngleY;
		this.bucket2.rotateAngleZ = this.rightarm.rotateAngleZ;
		this.handle1.rotateAngleX = this.rightarm.rotateAngleX;
		this.handle1.rotateAngleY = this.rightarm.rotateAngleY;
		this.handle1.rotateAngleZ = this.rightarm.rotateAngleZ;
		
		this.bucket1.rotateAngleX = this.leftarm.rotateAngleX;
		this.bucket1.rotateAngleY = this.leftarm.rotateAngleY;
		this.bucket1.rotateAngleZ = this.leftarm.rotateAngleZ;
		this.handle2.rotateAngleX = this.leftarm.rotateAngleX;
		this.handle2.rotateAngleY = this.leftarm.rotateAngleY;
		this.handle2.rotateAngleZ = this.leftarm.rotateAngleZ;
	}
