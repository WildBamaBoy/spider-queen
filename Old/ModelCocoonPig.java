...
public class ModelCocoonPig extends ModelBase
{

    public ModelCocoonPig()
    {
		float scale = 0F;
		Cocoon1 = new ModelRenderer(this,16, 8);
		Cocoon1.addBox(0F, 0F, 0F, 12, 12, 12, scale);
		Cocoon1.setRotationPoint(-6F, 2F, -6F);

		Cocoon2 = new ModelRenderer(this,20, 13);
		Cocoon2.addBox(0F, 0F, 0F, 10, 9, 10, scale);
		Cocoon2.setRotationPoint(-5F, -2F, -5F);

		Head = new ModelRenderer(this,0, 0);
		Head.addBox(-4F, -4F, -7F, 8, 8, 8, scale);
