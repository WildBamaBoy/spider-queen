...
public class ModelQueenBee extends ModelBase
{
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		this.crown.rotateAngleY = this.head.rotateAngleY; this.crown.rotateAngleX = this.head.rotateAngleX;
		...
		this.Scepter1.rotateAngleX = this.rightarm.rotateAngleX-3.14F/3F;this.Scepter1.rotateAngleY = this.rightarm.rotateAngleY;this.Scepter1.rotateAngleZ = this.rightarm.rotateAngleZ;
		this.Scepter2.rotateAngleX = this.rightarm.rotateAngleX-3.14F/3F;this.Scepter2.rotateAngleY = this.rightarm.rotateAngleY;this.Scepter2.rotateAngleZ = this.rightarm.rotateAngleZ;
