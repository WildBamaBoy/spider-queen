...
public class EntityWeb extends Entity
{
	...
	public void setEntityDead2()
	{
		...
		if (rr.nextInt(2) == 0)
		{
			this.motionY = this.motionY * -0.2F;
		}
		if (rr.nextInt(2) == 0)
		{
	...
	public void onUpdate()
	{
		...
		// if(this.prevRotationPitch == 0.0F && this.prevRotationYaw == 0.0F)
		// {
		// final float f = MathHelper.sqrt_double(this.motionX * this.motionX +
		// this.motionZ * this.motionZ);
		// this.prevRotationYaw = this.rotationYaw =
		// (float)(Math.atan2(this.motionX, this.motionZ) * 180D /
		// 3.1415927410125732D);
		// this.prevRotationPitch = this.rotationPitch =
		// (float)(Math.atan2(this.motionY, f) * 180D / 3.1415927410125732D);
		// }
		...
		// if(this.inGround)
		// {
		// final int i = this.worldObj.getBlock(this.xTile, this.yTile,
		// this.zTile);
		...
		// this.field_680_i++;
		// }
		// Vec3 vec3d = Vec3.createVectorHelper(this.posX, this.posY,
		// this.posZ);
		// Vec3D vec3d1 = Vec3.createVectorHelper(this.posX + this.motionX,
		// this.posY + this.motionY, this.posZ + this.motionZ);
		// MovingObjectPosition movingobjectposition =
		// this.worldObj.rayTraceBlocks(vec3d, vec3d1);
		...
		// this.motionZ).expand(1.8D, 1.8D, 1.8D));
		// double d = 0.0D;
		//
		// for(int j = 0; j < list.size(); j++)
		// {
		// final Entity entity1 = (Entity)list.get(j);
		// if(!entity1.canBeCollidedWith() || entity1 == this.field_682_g &&
		// this.field_680_i < 5)
		// {
		// continue;
		// }
		// final float f4 = 0.05F;
		// final AxisAlignedBB axisalignedbb = entity1.boundingBox.expand(f4,
		// f4, f4);
		// final MovingObjectPosition movingobjectposition1 =
		...
		// {
		// final EntityLivingBase enl = (EntityLivingBase)
		...
		// EntityCocoonHuman(this.worldObj, movingobjectposition.entityHit.posX,
		...
		// // {
		// // this.worldObj.spawnEntityInWorld(new EntityCocoon(this.worldObj,
		...
		// // {
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonPig(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonSheep(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonCreeper(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonZombie(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// // if(rr.nextInt(hh / 6 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonCow(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonSkeleton(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonWolf(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // this.setDead();
		// // }
		// // if(movingobjectposition.entityHit instanceof EntityAnt ||
		// movingobjectposition.entityHit instanceof EntityRedAnt)
		// // {
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonAnt(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonWasp(this.worldObj, movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		// //
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonGatherer(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// // if(rr.nextInt(hh / 4 + 1) != 0) { this.setEntityDead2(); return; }
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonWarrior(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// // this.worldObj.spawnEntityInWorld(new
		// EntityCocoonQueenBee(this.worldObj,
		// movingobjectposition.entityHit.posX,
		// // movingobjectposition.entityHit.posY,
		// movingobjectposition.entityHit.posZ,
		// // movingobjectposition.entityHit.rotationYaw,0));
		...
		// //{
		// bID = this.worldObj.getBlock((int)(this.posX + this.motionX / 25F *
		// fm),(int)(this.posY + this.motionY / 25F * fm),(int)(this.posZ +
		// this.motionZ / 25F * fm));
		...
		// //if(bID != mod_SpiderQueen.smallWeb)
		// //{
		// // bID = worldObj.getBlock((int)(movingobjectposition.hitVec.xCoord +
		// motionX / 25F * fm),(int)(movingobjectposition.hitVec.yCoord +
		// motionY / 25F * fm),(int)(movingobjectposition.hitVec.zCoord +
		// motionZ / 25F * fm));
		// //if(bID == Blocks.web) { fm = 55F; }
		// //}
		// fm = fm + 5F;
		...
		// while(ff < 100)
		// {
		// this.xTile = (int)(movingobjectposition.hitVec.xCoord - this.motionX
		// / 25F * ff);
		// this.yTile = (int)(movingobjectposition.hitVec.yCoord - this.motionY
		// / 25F * ff);
		// this.zTile = (int)(movingobjectposition.hitVec.zCoord - this.motionZ
		// / 25F * ff);
		...
		// {
		// if(this.worldObj.getBlockMetadata(this.xTile, this.yTile, this.zTile)
		// < 1)
		// {
		// this.worldObj.setBlockMetadata(this.xTile, this.yTile, this.zTile,
		...
		// {
		//
		// this.worldObj.setBlockWithNotify(this.xTile, this.yTile, this.zTile,
		// Blocks.web);
		//
		...
		//
		//
		// final float f2 = MathHelper.sqrt_double(this.motionX * this.motionX +
		// this.motionZ * this.motionZ);
		// this.rotationYaw = (float)(Math.atan2(this.motionX, this.motionZ) *
		// 180D / 3.1415927410125732D);
		// for(this.rotationPitch = (float)(Math.atan2(this.motionY, f2) * 180D
		// / 3.1415927410125732D); this.rotationPitch - this.prevRotationPitch <
		// -180F; this.prevRotationPitch -= 360F) { }
		// for(; this.rotationPitch - this.prevRotationPitch >= 180F;
		// this.prevRotationPitch += 360F) { }
		// for(; this.rotationYaw - this.prevRotationYaw < -180F;
		...
		// this.worldObj.spawnParticle("bubble", this.posX - this.motionX * f6,
		// this.posY - this.motionY * f6, this.posZ - this.motionZ * f6,
