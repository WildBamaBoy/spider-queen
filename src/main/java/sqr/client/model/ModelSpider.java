...
public class ModelSpider extends ModelBase
{
	...
	public void render(Entity entity, float limbSwing, float prevLimbSwing, float rotateFloat, float rotationYaw, float rotationPitch, float partialTickTime)
	{
		...
		// this.setRotationAngles(limbSwing, prevLimbSwing, rotateFloat,
		// rotationYaw, rotationPitch, partialTickTime, entity);
		//
	...
	public void setRotationAngles(float limbSwing, float prevLimbSwing, float rotateFloat, float rotationYaw, float rotationPitch, float partialTickTime, Entity entity)
	{
		...
		// final EntityHatchedSpider spider = (EntityHatchedSpider) entity;
		//
		// if (EnumTypeVariant.isAnimalBased(spider.cocoonType) ||
		// spider.cocoonType == EnumTypeVariant.EMPTY || spider.cocoonType ==
		// EnumTypeVariant.VILLAGER || spider.cocoonType ==
		// EnumTypeVariant.HUMAN || spider.cocoonType == EnumTypeVariant.HORSE)
		// {
		// this.defaultSpiderHead.rotateAngleY = rotationYaw / (180F / (float)
		// Math.PI);
		// this.defaultSpiderHead.rotateAngleX = rotationPitch / (180F / (float)
		// Math.PI);
		//
		...
		//
		// final float frontRotateY = -(MathHelper.cos(limbSwing * 0.6662F *
		// 2.0F) * 0.4F) * prevLimbSwing;
		// final float frontMidRotateY = -(MathHelper.cos(limbSwing * 0.6662F *
		// 2.0F + (float) Math.PI) * 0.4F) * prevLimbSwing;
		// final float backMidRotateY = -(MathHelper.cos(limbSwing * 0.6662F *
		// 2.0F + (float) Math.PI / 2F) * 0.4F) * prevLimbSwing;
		// final float backRotateY = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F
		// + (float) Math.PI * 3F / 2F) * 0.4F) * prevLimbSwing;
		// final float frontRotateZ = Math.abs(MathHelper.sin(limbSwing *
		// 0.6662F) * 0.4F) * prevLimbSwing;
		// final float frontMidRotateZ = Math.abs(MathHelper.sin(limbSwing *
		// 0.6662F + (float) Math.PI) * 0.4F) * prevLimbSwing;
		// final float backMidRotateZ = Math.abs(MathHelper.sin(limbSwing *
		// 0.6662F + (float) Math.PI / 2F) * 0.4F) * prevLimbSwing;
		// final float backRotateZ = Math.abs(MathHelper.sin(limbSwing * 0.6662F
		// + (float) Math.PI * 3F / 2F) * 0.4F) * prevLimbSwing;
		//
		...
		// final float f9 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F + 0.0F)
		// * 0.4F) * prevLimbSwing;
		// final float f10 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F +
		// 3.141593F) * 0.4F) * prevLimbSwing;
		// final float f11 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F +
		// 1.570796F) * 0.4F) * prevLimbSwing;
		// final float f12 = -(MathHelper.cos(limbSwing * 0.6662F * 2.0F +
		// 4.712389F) * 0.4F) * prevLimbSwing;
		// final float f13 = Math.abs(MathHelper.sin(limbSwing * 0.6662F + 0.0F)
		// * 0.4F) * prevLimbSwing;
		// final float f14 = Math.abs(MathHelper.sin(limbSwing * 0.6662F +
		// 3.141593F) * 0.4F) * prevLimbSwing;
		// final float f15 = Math.abs(MathHelper.sin(limbSwing * 0.6662F +
		// 1.570796F) * 0.4F) * prevLimbSwing;
		// final float f16 = Math.abs(MathHelper.sin(limbSwing * 0.6662F +
		// 4.712389F) * 0.4F) * prevLimbSwing;
		...
		// }
		//
		// else if (spider.cocoonType == EnumTypeVariant.ENDERMAN ||
		// spider.cocoonType == EnumTypeVariant._ENDERMINION)
		// {
		// final float quarterCircle = (float) Math.PI / 4F;
		...
		// {
		// this.flatSpiderHead.rotateAngleY = rotationYaw / (180F / (float)
		// Math.PI);
		// this.flatSpiderHead.rotateAngleX = rotationPitch / (180F / (float)
		// Math.PI);
		//
		// final float quarterCircle = (float) Math.PI / 4F;
